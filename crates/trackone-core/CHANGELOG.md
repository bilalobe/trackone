...
### Changed
- `trackone-core::VERSION` now reports `0.1.0-beta.4` to match the workspace
  release.
...
### Changed
- `trackone-core::VERSION` now reports `0.1.0-beta.2` to match the workspace
  release.

## [0.1.0-beta.1] - 2026-05-16

### Changed
- `trackone-core::VERSION` now reports `0.1.0-beta.1` to match the workspace
  release.

## [0.1.0-alpha.19] - 2026-05-16

### Changed
- `trackone-core::VERSION` now reports `0.1.0-alpha.19` to match the
  workspace release.
