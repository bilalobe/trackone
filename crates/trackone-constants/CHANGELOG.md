...
- The workspace no longer carries the unpublished `trackone-python` binding
  leaf; shared constants remain Rust-native.

## [0.1.0-beta.4] - 2026-07-18

### Notes
- No new constant values landed; the crate remains aligned with the workspace
  `0.1.0-beta.4` release line.

## [0.1.0-beta.3] - 2026-07-17

### Notes
- No new constant values landed; the crate remains aligned with the workspace
  `0.1.0-beta.3` release line.

## [0.1.0-beta.2] - 2026-07-11

### Notes
- No new constant values landed; the crate remains aligned with the workspace
  `0.1.0-beta.2` release line.
...
### Notes
- No new constant values landed in this release; `trackone-constants` remains the shared no-std release-contract surface for the workspace `0.1.0-alpha.15` line.

## [0.1.0-alpha.14] - 2026-04-13

### Notes
- No new constant values landed in this release; `trackone-constants` remains the shared no-std release-contract surface for the workspace `0.1.0-alpha.14` line.

## [0.1.0-alpha.13] - 2026-04-03

### Notes
- No new constant values landed in this release; `trackone-constants` remains the shared no-std release-contract surface for the workspace `0.1.0-alpha.13` line.
